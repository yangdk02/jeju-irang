  ...
  .:
    dependencies:
      '@napi-rs/canvas':
        ...
        version: 0.1.100
      '@oai/artifact-tool':
        specifier: file:./local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.22.tgz
        version: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.22.tgz
      '@viz-js/viz':
        specifier: 3.25.0
        version: 3.25.0
      docx:
...
packages:
  ...
  '@oai/artifact-tool@file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.22.tgz':
    resolution: {integrity: sha512-+9Vng1shz9zCLVzOEb21bXCUj60LcNzqkzxNz8IAbK3i+hVUKhJ7uqRBMVpN9KkXIbmqXWZzfzv3DssEkS3m0w==, tarball: file:local-deps/-oai-artifact-tool-oai-artifact_tool-2.8.22.tgz}
    version: 2.8.22
    bundledDependencies:
      - '@oai/walnut'
      - skia-canvas
